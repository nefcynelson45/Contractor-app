...
Route::post('/loginread',[LoginController::class,'login'])->name('log');
...
Route::post('/customerread',[RegistrationController::class,'store']);
Route::get('/custlog',[LoginController::class,'store']);
