    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="/matsearch" method="post" >
          {{csrf_field()}}
...
<form action="/matread" method="post">
{{csrf_field()}}

            <label >NAME : </label >
            <input type="text" name="matname" style="width: 100%;"  class="form-control" placeholder="Material Name" required></div></div>
            <div class="col-md-5">
            <div class="form-group">
            <label >RATE :  </label >
            <div class="row">
            <input type="text" name="rate" style="width: 90%;" class="form-control" placeholder="Material Rate" required></td>
    ...
    <center><button class="btn btn-primary">ADD MATERIAL</button></center>
    </form>
    ...
    <br>
      ...
      <tbody class="table-active" >
        ...
        <tr>
            ...
            <td>{{$mat->mat_name}}</td>
            <td>{{$mat->rate}}</td>
            <td><a href="/mat/{{$mat->mat_id}}/edit" class="btn btn-app-sm bg-warning">
                  <i class="fas fa-edit"></i> Edit</a></td>
            <td><a href="/mat/{{$mat->mat_id}}/delete" class="btn btn-app-sm bg-danger" onclick="return confirm('Do You Really want to Delete?');">
