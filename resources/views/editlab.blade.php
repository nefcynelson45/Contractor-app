  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Labor</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin">Home</a></li>
              <li class="breadcrumb-item"><a href="/addlabor">Labor</a></li>
...
<form action="/laboreditprocess/{{$labors->l_id}}" method="post">
{{csrf_field()}}

            <label > Labor Type :</label> 
            <input type="text" value="{{$labors->l_type}}" name="type" class="form-control" style="width: 100%;" placeholder="Enter the Labor Type" required>
            </div></div>
            <div class="col-md-6">
            <div class="form-group">
            <label >Rate : </label> 
            <input type="number" value="{{$labors->Amount}}" name="rate" class="form-control" style="width: 100%;" placeholder="Labor Rate" required>
</div></div></div>

    <center><button class="btn btn-primary">Update Labor</button></center>
    </form>
        </div>
              <!-- /.card-body -->
            </div>
