  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Constructions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin">Home</a></li>
              <li class="breadcrumb-item"><a href="/addconst">Constructions</a></li>
...
<form action="/conseditprocess/{{$cons->cons_id}}" method="post">
{{csrf_field()}}
    
    <label >CONSTRUCTION :</label >
    <input type="text" value="{{$cons->cons_type}}" name="cons" style="width:80%;"  class="form-control" placeholder="Name of the Construction type" required>
    </div></div>
    </div>
        
        <center><button class="btn btn-primary">Update Construction</button></center>
    </form>
</div>
              <!-- /.card-body -->
            </div>
