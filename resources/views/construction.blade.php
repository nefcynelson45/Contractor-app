    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="/consearch" method="post" >
          {{csrf_field()}}
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="/addconst" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Constructions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<form action="/consread" method="post">
{{csrf_field()}}
&nbsp;<span class="badge bg-danger">New</span> Constructions here!<br><br>
    
    <label >CONSTRUCTION :</label >
    <input type="text" name="cons" style="width:80%;"  class="form-control" placeholder="Name of the Construction type" required>
    </div></div>
    </div>
        </div>
        <center><button class="btn btn-primary">ADD CONSTRUCTION</button></center>
    </form>
    ...
    <br>
        ...
        <center>
        <table class="table " style="max-width:70%; font-family:Lato;">
