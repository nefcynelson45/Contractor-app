...
{{csrf_field()}}
              ...
              <div class="col-md-6">
                ...
                <br><label class="lead" ><strong> Labor Service</strong></label>
                    <input type="checkbox"  id="btncheck1" name="lab" value="yes" autocomplete="off" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    <label class="lead" ><strong> Materials</strong></label>
                    <input type="checkbox" name="mat" value="yes" id="btncheck1" autocomplete="off" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
