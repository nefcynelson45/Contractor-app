...
<form action="/workeditprocess/{{$work->w_id}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
    ...
    <select class="form-control select2" name="stat" style="width: 100%;" required>
        ...
        <center><button class="btn btn-primary">Update Work</button></center>
    </form>
</div>
              <!-- /.card-body -->
            </div>
