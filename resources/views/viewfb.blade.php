        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/viewfb" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Feedback</p>
                </a>
              </li>
    ...
    <section class="content">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>{{$fdb->id}}</td>
            <td>{{optional($fdb->customer)->cust_name}}</td>
            <td>{{$fdb->feedback}}</td>
            <td>{{$fdb->date}}</td>
            <td><a href="/feedback/{{$fdb->f_id}}/edit" class="btn btn-app-sm bg-warning">
                  <i class="fas fa-edit"></i> Edit</a></td>
            <td><a href="/feedback/{{$fdb->f_id}}/delete" onclick="return confirm('Do You Really want to Delete?');" class="btn btn-app-sm bg-danger">
