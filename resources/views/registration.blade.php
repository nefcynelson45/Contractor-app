        ...
        <div class="screen-body-item">
          ...
          <div class="app-form">
            <div class="app-form-group">
              <input type="text" name="cust_name" class="app-form-control"  placeholder="Name" required>
            </div>
            <div class="app-form-group">
            <input type="text"  name="cust_email" class="app-form-control"  placeholder="Email" required>
            </div>
            <div class="app-form-group">
            <input type="number"  name="phone" class="app-form-control"  placeholder="Phone No." required>
            </div>
            <div class="app-form-group">
            ...
            <div class="app-form-group">
            <input type="date"  name="dob" class="app-form-control" placeholder="dob" required>
            </div>
            <div class="app-form-group">
            <input type="password" name="password" class="app-form-control"  placeholder="Password" required>
            </div>
            <div class="app-form-group">
            <input type="password" class="app-form-control" name="cpwd" placeholder="Confirm Password" required>
            </div>
