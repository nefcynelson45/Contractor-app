...
<form action="/fbread/{{$book['id']}}" method="post">
@endforeach
{{csrf_field()}}
    <table class="table table-borderless">
    <tr><td>
    <center><img src="/dist/img/feedback.png" alt="" height="200"></center>
    </td></tr>
        <tr>
        
            <td><center><textarea name="feedback" id="" cols="30" rows="10" class="form-control" style="max-width:50%;" placeholder="Enter your Feedback here" required></textarea></center></td>
        </tr>
    </table>
    <center><button class="btn btn-primary">Add Feedback</button></center></form>
    </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
